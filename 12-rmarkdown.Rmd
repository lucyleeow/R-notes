...
For me, downloading and installing XQuartz (then restarting the computer so it is the default X11), then re-running the code with `dev='cairo_pdf'` set worked.
