...
Code in a code chunk running off the page you can:
...
Plots running off the marging, either on the side or bottom of the page. Mostly occuring when outputting plots from a for loop. 
