...
If you add legend labels - notice how `labels` are mapped to your `"blue"` and `"red"` NOT according to the order the appear in, in the code, but in alphabetical order. See [this](https://stackoverflow.com/questions/47317338/how-do-i-change-line-color-in-ggplot2-without-legend-disappearing) question on SO for more.
