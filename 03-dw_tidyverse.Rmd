...
See [SO](https://stackoverflow.com/questions/42385010/using-the-pipe-and-dot-notation) for more details.
...
See [dplyr reference](https://dplyr.tidyverse.org/reference/select_helpers.html) for more details.
...
When using the `.` with `group_by()` and `mutate_at()`/`mutate()` or `summarise_at()`/`summarise()`, the grouping is respected! See [SO](https://stackoverflow.com/questions/48182815/when-to-use-do-function-in-dplyr) for more details.
...
(See [SO](https://stackoverflow.com/questions/35272457/what-does-the-dplyr-period-character-reference) for more details)
